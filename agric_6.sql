...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2025 at 07:25 PM
...
(3, 1010228, 'Labour Cost', 'TR959061025103639', 10000.00, 'outflow', 'operating', 1, '2025-10-06 10:36:39', 1),
(4, 1010228, 'Labour Cost', 'TR007061025025310', 10000.00, 'outflow', 'operating', 1, '2025-10-06 14:53:10', 1),
(5, 1010228, 'Labour Cost', 'TR966061025025322', 20000.00, 'outflow', 'operating', 1, '2025-10-06 14:53:22', 1),
(6, 1010228, 'Labour Cost', 'TR994061025062105', 3000.00, 'outflow', 'operating', 1, '2025-10-06 18:21:05', 1);
...
(1, 18, 'Farm Input', 1, 2500, 395, 0, NULL, 5, NULL),
(2, 15, 'Crop', 1, 189.655, 217, 0, NULL, 10, NULL),
...
--
ALTER TABLE `audit_trail`
  MODIFY `audit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `cash_flows`
  MODIFY `fow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `task_items`
  MODIFY `task_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
