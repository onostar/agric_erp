    ...
    <div class="add_user_form priceForm">
        ...
        <section style="text-align:left;">
            <div class="inputs" style="flex-wrap:wrap; gap:.5rem;justify-content:left">
                ...
                <div class="data" style="width:23%">
                    <label for="sales_price">Industrial Price (NGN)</label>
                    <input type="text" name="sales_price" id="sales_price" value="<?php echo $sales?>">
                </div>
                <div class="data" style="width:23%">
                    <label for="other_price">Non-Industrial Price (NGN)</label>
                    <input type="text" name="other_price" id="other_price" value="<?php echo $other_price?>">
                </div>
                
                <div class="data" style="width:auto">
                    <button type="submit" id="change_price" name="change_price" onclick="changeItemPrice('briquette_price.php')">Save <i class="fas fa-save"></i></button>
