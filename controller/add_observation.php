        ...
        <section class="addUserForm">
            <div class="inputs">
                ...
                <div class="data" style="width:100%">
                    <label for="observation">Observation / Remark</label>
                    <input type="text" name="observation" id="observation" placeholder="Input Observations" required>
                </div>
                <div class="data" style="width:auto">
                    <button type="button" id="add_cat" name="add_cat" onclick="addObservation()">Save <i class="fas fa-layer-group"></i></button>
