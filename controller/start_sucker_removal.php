...
?>  <div class="info"></div>
    <div class="add_user_form" style="width:50%; margin:10px">
        <h3 style="padding:8px; font-size:.8rem;text-align:left;background:var(--tertiaryColor); color:#fff;">Remove Suckers</h3>
            ...
            <div class="inputs">
               ...
               <!--  <input type="hidden" name="crop" id="crop" value="<?php echo $crop?>"> -->
                ...
                <div class="data" style="width:auto">
                    <button type="button" id="add_cat" name="add_cat" onclick="removeSuckers()">Save <i class="fas fa-layer-group"></i></button>
