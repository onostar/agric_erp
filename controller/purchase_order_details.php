    ...
    <table id="stock_items_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a style="color:red; font-size:1rem" href="javascript:void(0) "title="delete purchase" onclick="deletePO('<?php echo $detail->purchase_id?>', <?php echo $detail->item?>)"><i class="fas fa-trash"></i></a>
                </td>
