...
?>  <div class="info"></div>
    <div class="add_user_form" style="width:50%; margin:10px">
        <h3 style="padding:8px; font-size:.8rem;text-align:left;background:var(--tertiaryColor)">Start Sucker Removal For CY0<?php echo $cycle?></h3>
        ...
        <section class="addUserForm">
            <div class="inputs" style="gap:1rem">
                ...
                <div class="data" style="width:48%">
                    ...
                    <input type="text" name="task_title" id="task_title" value="SUCKER REMOVAL" readonly>
                </div>
                <div class="data" style="width:48%">
