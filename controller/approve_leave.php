...
if(isset($_GET['id'])){
    ...
    if($recall){
        ...
        $email_message = "
            <p>Dear $employee,</p>
            <p>Your leave application has been <strong>approved</strong> by management.</p>
        ...
        echo "<div class='success'><p>Leave request approved successfully! <i class='fas fa-thumbs-up'></i></p></div>";
    }
}
?>
