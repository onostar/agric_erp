<?php
    ...
    $details = $get_revenue->fetch_details_2dateConOrder('rent_payments', 'customer', 'date(post_date)', $from, $to, $customer, 'post_date');
    $n = 1;
?>
<h2>Rent Return Received between '<?php echo date("jS M, Y", strtotime($from)) . "' and '" . date("jS M, Y", strtotime($to))?>'</h2>
    <hr>
    <div class="search">
...
<?php
    ...
    $ttls = $get_revenue->fetch_sum_2dateCond('rent_payments', 'amount', 'customer', 'date(post_date)', $from, $to,  $customer);
