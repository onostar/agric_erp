<?php
    ...
    if(isset($_GET['task_id'])){
        ...
        $invoice = "IN".$ran_num.$todays_date;
            ...
            <section>
                <div class="inputs" style="display:flex!important; gap:.3rem; flex-wrap:wrap; justify-content:left; align-items:flex-end">
                    ...
                    <div class="data" style="width:auto!important; margin:5px 0!important">
                        <button type="button" id="add_cat" name="add_cat" onclick="addGeneralTaskItem()">Save <i class="fas fa-layer-group"></i></button>
                        <a style="border-radius:15px; background:#dfdfdf;color:#222;padding:8px; box-shadow:1px 1px 1px #222"href="javascript:void(0)" onclick="showPage('general_task_details.php?task=<?php echo $task?>')"><i class="fas fa-close"></i> Close</a>
                    </div>
                </div>
                
            </section>
        </div>
        <div class="displays allResults" id="new_data" style="width:60%!important; margin: 10px 30px!important">
