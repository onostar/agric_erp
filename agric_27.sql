...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2025 at 05:20 PM
...
(12, 9, 10, 3, 1, 25.00, 3750000.00, 15000000.00, 15000000.00, '2025-11-14', '2025-11-14', 1, 1, '2025-11-13 14:34:42');
...
(8, 8, 1, 0, '', '2025-11-04 00:00:00', '2025-11-11 00:00:00', 310, 100.00, 0, '', '2025-11-04 17:00:51', 1, NULL, 0),
(9, 8, 1, 0, '', '2025-11-13 00:00:00', NULL, 0, 250.00, 0, '', '2025-11-11 15:23:49', 1, NULL, 0),
...
(150, 12, 9, 10, 15000000.00, 8000000.00, 0.00, 1, '2025-11-14', 0, '2025-11-13 14:34:42', 1);
...
(5, 18, 'Farm Input', 1, 1000, 310, 0, NULL, 5, NULL),
(6, 20, 'Farm Input', 1, 500, 2752, 0, NULL, 10, NULL),
(7, 1, 'Crop', 1, 650, 300, 0, NULL, 10, NULL);
...
(1, '12', 37, 'PINEAPPLE', 'Crop', 650, 5000, 0, 0, 0, 0, 10, '', 0, '2025-09-18 12:23:46'),
(18, '1', 38, 'NPK FERTILIZER', 'Farm Input', 1000, 5000, 0, 0, 0, 0, 5, '', 0, '2025-09-18 15:04:22'),
(19, '12', 37, 'BEANS', 'Crop', 0, 0, 0, 0, 0, 0, 10, '', 0, '2025-10-31 12:34:27'),
(20, '1', 39, 'SUCKER', 'Farm Input', 500, 0, 0, 0, 0, 0, 10, '', 0, '2025-11-10 07:01:16');
...
INSERT INTO `sucker_removal` (`sucker_id`, `farm`, `field`, `cycle`, `crop`, `quantity`, `trx_number`, `removed_by`, `date_removed`) VALUES
(1, 1, 8, 8, 20, 40, 'TR103121125011505', 1, '2025-11-12 13:15:05'),
(2, 1, 8, 8, 20, 10, 'TR426121125011551', 1, '2025-11-12 13:15:51'),
(3, 1, 8, 8, 20, 12, 'TR520121125011620', 1, '2025-11-12 13:16:20');
...
--
ALTER TABLE `audit_trail`
  MODIFY `audit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
...
--
ALTER TABLE `cash_flows`
  MODIFY `fow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `crop_removal`
  MODIFY `removal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `field_payment_schedule`
  MODIFY `repayment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
...
--
ALTER TABLE `harvests`
  MODIFY `harvest_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `rent_schedule`
  MODIFY `repayment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
...
--
ALTER TABLE `sucker_removal`
  MODIFY `sucker_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `task_items`
  MODIFY `task_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
