...
<div id="revenueReport" class="displays management" style="margin:0!important;width:100%!important">
    <div class="select_date">
        ...
        <section>    
            ...
            <button type="submit" name="search_date" id="search_date" onclick="search('search_customer_investment_deposits.php')">Search <i class="fas fa-search"></i></button>
        </section>
    </div>
<div class="displays allResults new_data" id="revenue_report">
    <h2>Todays Investment Deposit</h2>
    <hr>
    <div class="search">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_details->fetch_details_curdateCon('investment_payments', 'post_date', 'customer', $customer);
    ...
    <?php
        ...
        $ttls = $get_details->fetch_sum_curdateCon('investment_payments', 'amount_in_dollar', 'date(post_date)', 'customer', $customer);
