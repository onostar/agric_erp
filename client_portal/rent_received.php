...
<div id="revenueReport" class="displays management" style="margin:0!important;width:100%!important">
    <div class="select_date">
        ...
        <section>    
            ...
            <button type="submit" name="search_date" id="search_date" onclick="search('search_client_rent.php')">Search <i class="fas fa-search"></i></button>
        </section>
    </div>
<div class="displays allResults new_data" id="revenue_report">
    <h2>Rent Received Today</h2>
    <hr>
    <div class="search">
        <input type="search" id="searchRoom" placeholder="Enter keyword" onkeyup="searchData(this.value)">
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('data_table', 'Todays Rent returns Payments')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_details->fetch_details_curdateCon('rent_payments', 'post_date', 'customer', $customer);
            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        $ass = $get_details->fetch_details_group('assigned_fields', 'field', 'assigned_id', $detail->loan);
                        $field = $get_details->fetch_details_group('fields', 'field_name', 'field_id', $ass->field);
    ...
    <?php
        ...
        $ttls = $get_details->fetch_sum_curdateCon('rent_payments', 'amount', 'date(post_date)', 'customer', $customer);
