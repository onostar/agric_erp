...
<head>
    ...
    <title>Client Portal | Forgot Password</title>
    ...
    <main id="reg_body">
        ...
        <section class="reg_log">
            ...
            <div class="login_page">
                ...
                <h2>Client Portal</h2>
                <p>Forgot your password? Enter your email address below to reset your password.</p>
                <?php
                ...
                <form action="../controller/recover_password.php" method="POST">
                    ...
                    <div class="data">
                        <button type="submit" id="submit_link" name="submit_link">Send Reset Link <i class="fas fa-paper-plane"></i></button>
