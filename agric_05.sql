...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2025 at 08:44 PM
...
INSERT INTO `staffs` (`staff_id`, `staff_number`, `last_name`, `other_names`, `gender`, `title`, `dob`, `marital_status`, `religion`, `phone`, `home_address`, `email_address`, `nok`, `nok_relation`, `nok_phone`, `employed`, `department`, `staff_group`, `staff_category`, `designation`, `discipline`, `bank`, `account_num`, `pension`, `pension_num`, `photo`, `signature`, `staff_status`, `user_id`, `resigned`, `resigned_by`, `reg_date`, `posted_by`) VALUES
(99896, '001', 'HEINZE', 'GABRIEL', 'Male', 'Eng.', '1993-08-30', 'Single', 'Christian', '08100123456', '23 Ajah Way, Lagos', 'heinzegabriel@mail.com', 'PAUL HEINZE', 'BROTHER', '08012345678', '2025-09-30', 3, 'core staff', 'senior staff', 16, 14, 0, 0, '', '', 'user.png', '', 0, 0, '2025-10-20 18:56:18', 1, '2025-10-20 12:31:00', 1);
