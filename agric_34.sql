...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2025 at 11:17 AM
...
(12, 9, 10, 3, 1, 25.00, 3750000.00, 15000000.00, 15000000.00, 0.00, 15000000.00, 250000.00, 0, '2025-11-14', '2025-11-14', 2, 1, '2025-11-13 14:34:42'),
...
(14, 'JAMES BROWN', 102, 10104102, 'Landowner', '123', '09012345678', 'Benin', 'onolunosepro@gmail.com', 0, 0, '2025-11-20 05:26:05', 1, NULL);
...
--
ALTER TABLE `cash_flows`
  MODIFY `fow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=211;
