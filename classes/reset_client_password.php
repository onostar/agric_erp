<?php
    ...
    class reset_password extends Dbh{
        protected function update_password($username, $newPassword){
            ...
            $change_password = $this->connectdb()->prepare("UPDATE customers SET user_password = :user_password WHERE customer_email = :customer_email");
            $change_password->bindValue("user_password", $hashed_pwd);
            $change_password->bindValue("customer_email", $username);
