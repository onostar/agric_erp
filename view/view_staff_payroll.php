...
<div id="salary_structure" class="displays">
        <a style="background:brown; color:#fff; padding:5px 8px; border-radius:15px; border:1px solid #fff; box-shadow:1px 1px 1px #222;" href="javascript:void(0)" onclick="showPage('generate_payroll.php')" title="Return to generate payroll">Return <i class="fas fa-angle-double-left"></i></a>
        ...
        <section>
            ...
            <div class="inputs" style="gap:.8rem; align-items:flex_end; justify-content:left;">
                ...
                <div class="data"style="width:auto">
                    <a style="padding:5px 8px; border-radius:15px;background:green;color:#fff; box-shadow:1px 1px 1px #222; border:1px solid #fff;" href="javascript:void(0)" onclick="printPaySlip('<?php echo $payroll?>')" title="Print Pay Slip">Print pay slip <i class="fas fa-print"></i></a>
                </div>
                <?php }?>
            </div>
        </section>    
