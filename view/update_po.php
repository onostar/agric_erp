...
<div class="displays allResults new_data" id="revenue_report">
    ...
    <div class="search">
        ...
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('data_table', 'Pending PO')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a style="color:green; background:var(--otherColor); padding:5px; border-radius:5px; color:#fff" href="javascript:void(0)" title="View invoice details" onclick="showPage('update_order.php?invoice=<?php echo $detail->invoice?>')"> <i class="fas fa-eye"></i> View</a>
                </td>
