...
<?php
    ...
    if(isset($_GET['customer']) && isset($_GET['schedule'])){
        ...
        //get loan details
        $lns = $get_details->fetch_details_cond('field_payment_schedule', 'repayment_id', $schedule);
        foreach($lns as $lns){
       ...
       //get total paid
       $ttls = $get_details->fetch_sum_single('field_payment_schedule', 'amount_paid', 'assigned_id', $assigned);
       ...
       //get total due
       $ttlx = $get_details->fetch_sum_single('field_payment_schedule', 'amount_due', 'assigned_id', $assigned);
...
<div class="back_invoice">
    <button class="page_navs" id="back" onclick="showPage('customer_field_payment.php?customer=<?php echo $customer_id?>')"><i class="fas fa-angle-double-left"></i> Back</button>
            ...
            <section class="addUserForm">
                <div class="inputs" style="flex-wrap:wrap">
                    ...
                    <div class="data" style="width:100%; margin:5px 0">
                        ...
                        <textarea name="details" id="details" cols="30" rows="5" placeholder="Enter a detailed description of the transaction">Payment for Land/Field Purchased</textarea>
                    </div>
                    <div class="data" style="width:50%; margin:5px 0">
