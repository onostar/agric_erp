<div id="add_bank" class="displays">
    ...
    <div class="add_user_form" style="width:50%; margin:20px 0">
        <h3 style="background:var(--tertiaryColor)">Upload Customers</h3>
        <form method="POST"  id="addCatForm" action="../controller/upload_customers.php" enctype="multipart/form-data">
            <div class="inputs">
                <div class="data">
                    <label for="items">Upload Customers</label>
