    ...
    <table id="room_list_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="color:var(--tertiaryColor)"><?php echo $detail->variety?>%</td>
                <td>
