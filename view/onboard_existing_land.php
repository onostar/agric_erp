...
<?php
    ...
    <div class="add_user_form priceForm" style="margin:10px 20px; width:70%;">
        <h3 style="background:var(--otherColor)">Assign "<?php echo strtoupper($row->field_name)?>" to client</h3>
            ...
            <div class="inputs" style="flex-wrap:wrap; gap:1rem; justify-content:left">
                ...
                <div class="data" style="width:31%">
                 ...
                 <div class="data" style="width:31%">
                    ...
                    <select name="payment_duration" id="payment_duration" onchange="calculateInstallments()">
                        ...
                        <option value="1" selected>Outright Purchase</option>
               ...
               <!--  <div class="data" style="width:31%">
                ...
                <div class="data" style="width:auto">
                    <button type="button" id="change_price" name="change_price" onclick="assignexistingField()">Onboard <i class="fas fa-save"></i></button>
                    <a href="javascript:void(0)" title="close form" style='background:red; padding:10px; border-radius:15px; border:1px solid #fff;box-shadow:1px 1px 1px #222; color:#fff' onclick="showPage('onboard_land_owners.php')">Return <i class='fas fa-angle-double-left'></i></a>
                </div>
