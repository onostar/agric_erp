...
<div class="displays allResults" id="staff_list" style="width:70%!important;margin:50px!important">
    ...
    <div class="search">
        ...
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('vendor_list_table', 'Vendor Payables')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
