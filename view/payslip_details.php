...
<div id="payrolls" class="displays">
        <a style="background:brown; color:#fff; padding:5px 8px; border-radius:15px; border:1px solid #fff; box-shadow:1px 1px 1px #222;" href="javascript:void(0)" onclick="showPage('payroll_report.php')" title="Return to payroll">Return <i class="fas fa-angle-double-left"></i></a>
    ...
    <div class="add_user_form" style="width:90%; margin:0px">
        ...
        <section>
            ...
            <?php if($status == 1 || $status == 2){
                //get approved by
                $apps = $get_details->fetch_details_group('users', 'full_name', 'user_id', $approved_by);
                $approval = $apps->full_name;    
            ?>
            <div class="inputs" style="gap:.8rem; align-items:flex_end; justify-content:left;">
                <div class="data"style="width:auto">
                    <label for="approved">Approved By:</label>
                    <input type="text"  value="<?php echo $approval?>" readonly style="border:none; border-bottom:1px solid #222; padding-left:1px;">
                </div>
                <div class="data"style="width:auto">
                    <label for="approved">Date Approved:</label>
                    <input type="text"  value="<?php echo date("jS M, Y", strtotime($approved))?>" readonly style="border:none; border-bottom:1px solid #222; padding-left:1px;">
                </div>
            </div>
            <?php }?>
        </section>    
