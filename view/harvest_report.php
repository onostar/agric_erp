...
<div id="production_report" class="displays management" style="width:100%!important;">
    <div class="select_date">
        ...
        <section>    
            ...
            <button type="submit" name="search_date" id="search_date" onclick="search('search_harvest_report.php')">Search <i class="fas fa-search"></i></button>
        </section>
    </div>
    <div class="displays allResults new_data" id="revenue_report">
        <h2>Todays's Harvest from <?php echo $store_name?></h2>
        <hr>
        <div class="search">
        ...
        <table id="data_table" class="searchTable">
            ...
            <tbody>
                <?php
                    ...
                    $details = $get_users->fetch_details_curdateCon('harvests', 'date(post_date)', 'farm', $store);
        ...
        <?php
            ...
            $prds = $get_users->fetch_sum_2colCurDate1Con('harvests', 'quantity', 'unit_cost', 'date(post_date)', 'farm', $store);
