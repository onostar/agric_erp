...
<div class="displays allResults" id="farm_fields" style="width:90%!important;margin:20px 50px!important">
    <h2>Onboard existing land owners</h2>
    <hr>
    <div class="search">
            ...
            <tr>
               ...
               <!--  <td><?php echo $detail->soil_type?></td>
                ...
                <td>
                    ...
                    ?>
                    <a href="javascript:void(0)" onclick="showPage('onboard_existing_land.php?field=<?php echo $detail->field_id?>')" style="color:#fff; background:var(--tertiaryColor); padding:5px; border:1px solid #fff; box-shadow:1px 1px 1px #cdcdcd; border-radius:15px;">Assign <i class="fas fa-user-tag"></i></a>
                    <?php }else{?>
