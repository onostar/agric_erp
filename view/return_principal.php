...
<div class="displays allResults new_data" id="revenue_report">
    <h2>Return Principal for Completed Concentrate Investments</h2>
    <hr>
    <div class="search">
        <input type="search" id="searchRoom" placeholder="Enter keyword" onkeyup="searchData(this.value)">
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('data_table', 'Completed Investments')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_details->fetch_details_2cond('investments', 'contract_status', 'principal', 2, 0);
            ...
            <tr>
                ...
                <td>
                    <a href="javascript:void(0)"  onclick="showPage('return_investment_principal.php?investment=<?php echo $detail->investment_id?>&customer=<?php echo $detail->customer?>')" style="color:#fff; background:var(--tertiaryColor); padding:5px; border:1px solid #fff; box-shadow:1px 1px 1px #222; border-radius:15px;" title="Return Principal"><i class="fas fa-hand-holding-dollar"></i></a>
