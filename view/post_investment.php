...
<?php
    ...
    if(isset($_GET['customer']) && isset($_GET['investment'])){
        ...
        $receipt_id = "INV".$todays_date.$ran_num.$user_id.$investment;
...
<div class="back_invoice">
    <button class="page_navs" id="back" onclick="showPage('post_investment_payment.php?customer=<?php echo $customer_id?>')"><i class="fas fa-angle-double-left"></i> Back</button>
...
<div id="deposit" class="displays">
    ...
    <div class="fund_account" style="width:80%; margin:5px 0;">
        <h3 style="background:var(--labColor); text-align:left">Post client Investment payments</h3>
            ...
            <section class="addUserForm">
                <div class="inputs" style="flex-wrap:wrap">
                    ...
                    <div class="data" style="width:100%; margin:5px 0">
                        ...
                        <textarea name="details" id="details" cols="30" rows="5">Payment for concentrate investment</textarea>
                    </div>
                    <div class="data" style="width:50%; margin:5px 0">
                        <button type="submit" id="post_exp" name="post_exp" onclick="postInvestment('fund_account')">Post payment <i class="fas fa-cash-register"></i></button>
                    </div>
                </div>
            </section>
