...
<?php
    ...
    <div class="add_user_form priceForm" style="margin:10px 20px; width:50%;">
        <h3 style="background:var(--tertiaryColor)">Onboard Existing Concentrate Investors</h3>
        <form style="text-align:left;">
            ...
            <!-- <div class="inputs" id="complete_invest"> -->
                ...
                <div class="data" style="width:auto; margin:5px 0">
                    <button type="button" style="background:var(--tertiaryColor)" id="change_price" name="change_price" onclick="onboardInvestors()">On-board <i class="fas fa-save"></i></button>
