    ...
    <table id="revenue_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><button style="box-shadow:1px 1px 1px #000;border-radius:4px; background:#c4c4c4; color:#000; padding:5px;" title="Print receipt" onclick="printReceipt('<?php echo $detail->invoice?>');"><i class="fas fa-print"></i> Print</button></td>
            </tr>
            <?php $n++; endforeach;}?>
        </tbody>
    </table>
