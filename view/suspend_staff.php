    ...
    <table id="disable_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_cond('staffs', 'staff_status', 0);
            ...
            <tr>
                ...
                <td>
                    <a style="padding:5px; border-radius:15px;background:var(--otherColor);color:#fff; box-shadow:1px 1px 1px #222; border:1px solid #fff" href="javascript:void(0)" onclick="suspendStaff('<?php echo $detail->staff_id?>')" title="Suspend Staff">Suspend <i class="fas fa-user-slash"></i></a>
                </td>
