...
<div id="sales_form" class="displays all_details">
    ...
    <div class="add_user_form" style="width:50%; margin:10px 0;">
        <h3 style="background:var(--labColor); color:#fff; text-align:left!important;">View Uploaded Documents</h3>
            ...
            <section class="addUserForm">
                <div class="inputs">
                    ...
                    <label for="customer">Search customer</label>
                        <input type="search" name="customer" id="customer" oninput="getCustomersName(this.value, 'get_customer_upload.php')" placeholder="Enter customer name or phone number">
