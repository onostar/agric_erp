        ...
        <section>
            <div class="inputs" style="gap:.8rem; align-items:flex_end; justify-content:left;">
                ...
                <div class="data" style="width:23%">
                    ...
                    <input type="number" id="basic_salary" name="basic_salary" required value=0>
                </div>
                <div class="data" style="width:23%;">
                   <label for="housing"> Housing Allow. (NGN)</label>
                   <input type="number" name="housing" id="housing" required value=0>
                </div>
                <div class="data" style="width:23%;">
                    <label for="medical">Medical Allow. (NGN)</label>
                    <input type="number" name="medical" id="medical" required value=0>
                </div>
                <div class="data" style="width:23%;">
                    <label for="transport">Transport Allow. (NGN)</label>
                    <input type="number" name="transport" id="transport" required value=0>
                </div>
                <div class="data" style="width:23%;">
                    <label for="utility">Utility Allowance (NGN)</label>
                    <input type="number" name="utility" id="utility" required value=0>
                </div>
                <div class="data" style="width:23%;">
                    <label for="others">Other Allowance (NGN)</label>
                    <input type="number" name="others" id="others" required value=0>
                </div>
                <div class="data">
