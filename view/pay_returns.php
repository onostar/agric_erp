...
<a style="border-radius:15px; background:brown;color:#fff;padding:10px; box-shadow:1px 1px 1px #222; position:fixed" href="javascript:void(0)" onclick="showPage('pay_investment_returns.php')"><i class="fas fa-angle-double-left"></i> Return</a>
