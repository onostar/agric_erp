...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2025 at 10:31 AM
...
(5, 18, 'Farm Input', 1, 1000, 314, 0, NULL, 5, NULL),
(6, 20, 'Farm Input', 1, 500, 3000, 0, NULL, 10, NULL);
...
--
ALTER TABLE `audit_trail`
  MODIFY `audit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `task_items`
  MODIFY `task_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
