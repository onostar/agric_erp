...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2025 at 10:14 AM
...
(5, 18, 'Farm Input', 1, 1000, 312, 0, NULL, 5, NULL),
(6, 20, 'Farm Input', 1, 500, 2690, 0, NULL, 10, NULL),
...
--
ALTER TABLE `task_items`
  MODIFY `task_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
