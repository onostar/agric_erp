...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2025 at 04:26 PM
...
INSERT INTO `payment_evidence` (`payment_id`, `assigned_id`, `field`, `customer`, `amount`, `evidence`, `remark`, `payment_status`, `posted_by`, `upload_date`) VALUES
(7, 15, 11, 10, 4000000.00, '02044_7.pdf', 'nil', 0, 10, '2025-11-20 15:48:57');
...
(203, 14, 'Receipt Upload', 'upload_payment', 0),
(204, 14, 'Receipt Upload Reports', 'receipt_upload_report', 0),
(205, 11, 'Approve Payment', 'approve_customer_payment', 0);
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
