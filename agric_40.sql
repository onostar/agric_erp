...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2025 at 02:39 PM
...
(6, 10, 10, 3, 'Dollar', 2000.00, 3100000.00, 1550.00, 2, 0, 1, '2025-11-27 07:22:06', '2025-11-28 13:04:18');
...
(22, '12', 37, 'CONCENTRATE', 'Crop', 0, 0, 0, 0, 0, 0, 10, '', 0, '2025-11-24 12:27:25');
...
--
ALTER TABLE `cash_flows`
  MODIFY `fow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `deposits`
  MODIFY `deposit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `ledgers`
  MODIFY `ledger_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
...
--
ALTER TABLE `notifications`
  MODIFY `notification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
--
ALTER TABLE `transactions`
  MODIFY `transaction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251;
