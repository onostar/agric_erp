...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2025 at 03:50 PM
...
(9, 7, 10, 3, 'Yearly', 3000000.00, 3000000.00, 9000000.00, '2025-11-01', '2028-11-01', 1, 1, '2025-10-31 12:00:55');
...
--
ALTER TABLE `assigned_fields`
  MODIFY `assigned_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;
