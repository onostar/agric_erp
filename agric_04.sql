...
INSERT INTO `staffs` (`staff_id`, `staff_number`, `last_name`, `other_names`, `gender`, `title`, `dob`, `marital_status`, `religion`, `phone`, `home_address`, `email_address`, `nok`, `nok_relation`, `nok_phone`, `employed`, `department`, `staff_group`, `staff_category`, `designation`, `discipline`, `bank`, `account_num`, `pension`, `pension_num`, `photo`, `signature`, `staff_status`, `user_id`, `reg_date`, `posted_by`) VALUES
(99896, '001', 'HEINZE', 'GABRIEL', 'Male', 'Eng.', '1993-08-30', 'Single', 'Christian', '08100123456', '23 Ajah Way, Lagos', 'heinzegabriel@mail.com', 'PAUL HEINZE', 'BROTHER', '08012345678', '2025-09-30', 3, 'core staff', 'senior staff', 16, 14, 0, 0, '', '', 'user.png', '', 0, 0, '2025-10-20 12:31:00', 1);
...
INSERT INTO `suspensions` (`suspension_id`, `staff`, `suspension_date`, `suspension_status`, `recall_date`, `recalled_by`, `suspended_by`) VALUES
(3, 99896, '2025-10-20 13:59:09', 1, '2025-10-20 13:59:15', 1, 1);
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=177;
