...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2025 at 06:30 PM
...
INSERT INTO `concentrate_production` (`production_id`, `production_num`, `store`, `pineapple`, `concentrate`, `pineapple_crown`, `pineapple_peel`, `pineapple_cost`, `pineapple_crown_value`, `pineapple_peel_value`, `others`, `trx_number`, `posted_by`, `date_produced`) VALUES
(1, 'PR1017122506273701', 10, 500.00, 2000.00, 500.00, 600.00, 3200.00, 1000.00, 1000.00, 0.00, 0, 1, '2025-12-17 18:28:14');
...
(9, 1, 'Crop', 10, 3200, 1500.000, 0, NULL, 10, NULL),
(10, 22, 'Crop', 10, 225, 4000.000, 0, NULL, 10, '2025-12-17 18:24:47'),
(11, 24, 'Crop', 10, 1000, 5100.000, 0, NULL, 10, '2025-12-17 18:24:47'),
(12, 23, 'Crop', 10, 1000, 4400.000, 0, NULL, 10, '2025-12-17 18:24:47'),
(13, 22, 'Crop', 10, 150, 2000.000, 0, NULL, 10, '2025-12-17 18:26:56'),
(14, 22, 'Crop', 10, 250, 2000.000, 0, NULL, 10, '2025-12-17 18:28:14');
...
(22, '12', 37, 'CONCENTRATE', 'Crop', 250, 0, 0, 0, 0, 0, 10, '', 0, '2025-11-24 12:27:25'),
(23, '12', 37, 'PINEAPPLE CROWN', 'Crop', 0, 1000, 0, 0, 0, 0, 10, '', 0, '2025-12-17 18:21:07'),
(24, '12', 37, 'PINEAPPLE PEEL', 'Crop', 0, 1000, 0, 0, 0, 0, 10, '', 0, '2025-12-17 18:21:17');
...
(18, 10, '09iuijijl', 1, 3200.00, 0, 4, 5000, 0.00, '', '0000-00-00', 0, NULL, 1, '2025-12-17 18:18:57');
...
(1, 'Administrator', 'Sysadmin', 'Admin', '$2y$10$dcUrnR/.PvfK7XeYcP60hOyW2qnPSSvEq/Wxee6lv5DETW8pbGXYu', 0, 10, '2022-09-27 13:47:21');
...
--
ALTER TABLE `audit_trail`
  MODIFY `audit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
...
--
ALTER TABLE `cash_flows`
  MODIFY `fow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;
...
--
ALTER TABLE `transactions`
  MODIFY `transaction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=259;
...
--
ALTER TABLE `waybills`
  MODIFY `waybill_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
