...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2025 at 04:07 PM
...
(85, 4, 6, 13, 'FARM LABOUR', 40601385);
...
INSERT INTO `tasks` (`task_id`, `farm`, `field`, `cycle`, `title`, `description`, `workers`, `labour_cost`, `trx_number`, `payment_status`, `done_by`, `post_date`) VALUES
(20, 1, 3, 4, 'IRRIGATION', 'Added Water To The Field', 'IKPEBA VICTOR, ADAMS OSHOMOLE', 4000.00, '', 0, 1, '2025-10-05 14:17:33'),
(21, 1, 3, 4, 'FERTILIZER APPLICATION', 'Applied Fertilizer On The Plants For Proper Growth', 'EMMA RED, JAMES BROWN', 5000.00, '', 0, 1, '2025-10-05 14:18:53');
...
(9, 21, 1, 3, 4, 18, 3, 2500.00, 7500.00, 'TR241051025021930', 1, '2025-10-05 14:19:30');
...
--
ALTER TABLE `expense_heads`
  MODIFY `exp_head_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `ledgers`
  MODIFY `ledger_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
