...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2025 at 03:32 PM
...
INSERT INTO `payroll` (`payroll_id`, `staff`, `store`, `payroll_date`, `gross_pay`, `tax`, `pension`, `lateness_penalty`, `absence_penalty`, `loan_repayment`, `other_deductions`, `net_pay`, `payroll_status`, `prepared_by`, `date_generated`) VALUES
(1, 99897, 1, '2025-10-24', 500000.00, 30000.00, 30400.00, 4000.00, 62000.00, 0.00, 0.00, 373600.00, 0, 1, '2025-10-24 14:31:09'),
(2, 99896, 1, '2025-10-24', 430000.00, 24750.00, 24800.00, 2000.00, 60000.00, 0.00, 0.00, 318450.00, 0, 1, '2025-10-24 14:32:18');
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=191;
