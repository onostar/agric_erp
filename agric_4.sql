...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2026 at 10:27 AM
...
INSERT INTO `assets` (`asset_id`, `asset`, `asset_no`, `location`, `supplier`, `cost`, `quantity`, `accum_dep`, `useful_life`, `salvage_value`, `book_value`, `ledger`, `specification`, `asset_status`, `purchase_date`, `deployment_date`, `store`, `post_date`, `posted_by`, `updated_by`, `updated_at`) VALUES
(3, 'MARYLAND FIELD', 'DAVIDORLAH/Dav/2025/11/3', 1, 'MABACH', 40000000.00, 1, 0.00, 10, 3000000.00, 40000000.00, 1020524, 'Jhhj', 2, '2025-11-11', '2025-11-19', 0, '2025-11-19 14:09:50', 1, 1, '2025-11-19 15:48:01'),
(5, 'SONGOTEDO PINEAPLE FARM', 'DAVIDORLAH/Dav/2026/01/5', 1, 'JAMESIBRAHIM', 20000000.00, 1, 0.00, 10, 15000000.00, 20000000.00, 1020524, 'Ghfg', 2, '2026-01-01', '2026-01-08', 0, '2026-01-07 14:08:16', 1, 0, NULL);
...
(12, 9, 10, 3, 1, 25.00, 3750000.00, 15000000.00, 15000000.00, 0.00, 15000000.00, 250000.00, 1, '2025-11-14', '2025-11-14', 2, 1, '2025-11-13 14:34:42'),
(14, 10, 12, 5, 3, 36.00, 10800000.00, 10000000.00, 30000000.00, 0.00, 30000000.00, 250000.00, 0, '2025-11-21', '2026-01-21', 2, 1, '2025-11-14 12:10:08'),
(15, 11, 10, 5, 3, 25.00, 6000000.00, 8000000.00, 25000000.00, 1000000.00, 24000000.00, 250000.00, 0, '2025-11-28', '2026-01-28', 2, 1, '2025-11-20 06:41:05'),
(16, 13, 10, 5, 3, 36.00, 900000.00, 833333.33, 3000000.00, 500000.00, 2500000.00, 350000.00, 0, '2026-01-07', '2026-03-09', 2, 1, '2026-01-07 14:46:27');
...
(9, 1, 0, 'IGANDO FARM FIELD', 10, 900.00, 'clay soil', 7.20, 'Irrigated', 'igando, lagos', 0.100000000, 0.100000000, 15000000.00, 0, '2025-11-13 10:55:57', 1, 1, '2025-11-13 11:03:13'),
...
(10, 10, 1, 3, 'Dollar', 1.85, 3700.00, 3700.00, 0.00, 1, 0, 1, '2026-01-13 09:56:59', '2025-12-13 13:54:40', 1, '2026-01-14 10:21:26');
...
(25, 99906, 1, '2026-01-07', 22, 1, 0, 0, 21, 200000.00, 50000.00, 50000.00, 30000.00, 20000.00, 0.00, 350000.00, 0.00, 0.00, 300000.00, 22400.00, 2000.00, 42000.00, 0.00, 0.00, 283600.00, 1, 1, '2026-01-07 11:22:32', '2026-01-07 11:28:17', 1);
...
INSERT INTO `principal_returns` (`payment_id`, `investment`, `client`, `amount`, `value_in_naira`, `payment_mode`, `bank`, `trx_date`, `trx_number`, `invoice`, `store`, `post_date`, `posted_by`) VALUES
...
(158, 15, 11, 10, 6000000.00, 0.00, 0.00, 1, '2026-12-23', 0, '2025-12-23 06:07:23', 1),
...
--
ALTER TABLE `cash_flows`
  MODIFY `fow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `deposits`
  MODIFY `deposit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `field_payment_schedule`
  MODIFY `repayment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=163;
...
--
ALTER TABLE `pensions`
  MODIFY `pension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `rent_schedule`
  MODIFY `repayment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;
...
--
ALTER TABLE `rights`
  MODIFY `right_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=236;
