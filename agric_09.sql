...
INSERT INTO `attendance` (`attendance_id`, `staff`, `store`, `attendance_date`, `time_in`, `time_out`, `attendance_status`, `remark`, `marked_by`, `marked_date`) VALUES
(3, 99897, 1, '2025-10-22', NULL, NULL, -1, '', 1, '2025-10-22 20:07:52');
...
(2, 99896, 2, 7, '2025-10-22', '2025-10-28', 7, 'Currently down with fever, need time off proper treatment', 1, 1, '2025-10-22 16:22:44', 1, 1, '2025-10-22 09:44:30', NULL, 0),
...
--
ALTER TABLE `leaves`
  MODIFY `leaves_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;
