...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2025 at 09:16 PM
...
(19, 23, 'Crop', 11, 1500, 27.000, 0, NULL, 10, NULL),
(20, 21, 'Crop', 11, 800, 25.200, 0, NULL, 10, NULL),
(21, 24, 'Crop', 11, 600, 20.000, 0, NULL, 10, NULL),
(22, 25, 'Crop', 11, 270, 100.000, 0, NULL, 10, '2025-12-18 21:09:53');
...
(1, 'Administrator', 'Sysadmin', 'Admin', '$2y$10$dcUrnR/.PvfK7XeYcP60hOyW2qnPSSvEq/Wxee6lv5DETW8pbGXYu', 0, 11, '2022-09-27 13:47:21');
...
--
ALTER TABLE `audit_trail`
  MODIFY `audit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
...
--
ALTER TABLE `briquette_production`
  MODIFY `production_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `cash_flows`
--
ALTER TABLE `cash_flows`
  MODIFY `fow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `cost_of_sales`
  MODIFY `cost_of_sales_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;
...
--
ALTER TABLE `transactions`
  MODIFY `transaction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=287;
