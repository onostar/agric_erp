...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2025 at 02:58 PM
...
(1, 18, 'Farm Input', 1, 2500, 407, 0, NULL, 5, NULL),
...
INSERT INTO `tasks` (`task_id`, `farm`, `field`, `cycle`, `title`, `description`, `item`, `quantity`, `workers`, `done_by`, `post_date`) VALUES
...
(5, 1, 3, 4, 'PLANTING', 'Planted Seeds For The Crop', 0, 0, 'JACOB JAMES, DANIEL JOHN', 1, '2025-10-04 13:24:05'),
(6, 1, 3, 4, 'WEEDING', 'Weeding Of All The Bad Plants While Applying Fertilizer', 0, 0, 'AKPABIO MATTHEW, JAMES TRAFFORD', 1, '2025-10-04 13:26:17'),
(7, 1, 3, 4, 'LAND WETTING', 'Poured Water On The Land To Make It Irrigated', 0, 0, 'EMMANUELA EKPENYONG, BISI OLADELE', 1, '2025-10-04 13:28:37'),
(8, 1, 3, 4, 'FERTILIZER APPLICATION', 'Applied Fertilizer On All The Fields, With Growth And Mould', 0, 0, 'IKPURI SAMUEL, IDAMA ANTHONY', 1, '2025-10-04 13:32:45'),
(9, 1, 3, 4, 'WEEDING PLANT', 'Weeding All The Plants', 0, 0, 'EMMA DANIEL, JAMES EBUKA', 1, '2025-10-04 13:34:27'),
(10, 1, 3, 4, 'WEEDING AGAIN O', 'Jkhkhf L;aefl Jkhjkafhjkhjk', 0, 0, 'EMMA, JAMES', 1, '2025-10-04 13:36:36'),
(11, 1, 3, 4, 'IRRIGATION', 'Adding Water To The Soil And Plants To Improve Growth', 0, 0, 'KELS ONOSTAR, EMMANUEL EKPEYONG', 1, '2025-10-04 13:43:18'),
(12, 1, 3, 4, 'WEEDING', 'Removing All The Weeds Using The Fertilizer', 0, 0, 'EMMA JAMES, KPENKUS AMONDA', 1, '2025-10-04 13:49:08'),
(13, 1, 3, 4, 'IRRIGATION', 'TOiled The Soild And Pour Water Inside', 0, 0, 'EMMA OKOYE, AKPU JAMES', 1, '2025-10-04 13:52:24');
...
INSERT INTO `task_items` (`task_item_id`, `task_id`, `item`, `quantity`, `unit_cost`, `total_cost`, `posted_by`, `post_date`) VALUES
(1, 11, 18, 10, 2500.00, 25000.00, 1, '2025-10-04 13:45:12'),
(2, 12, 18, 7, 2500.00, 17500.00, 1, '2025-10-04 13:49:29'),
(3, 13, 18, 3, 2500.00, 7500.00, 1, '2025-10-04 13:53:40');
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;
...
--
ALTER TABLE `task_items`
  MODIFY `task_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
